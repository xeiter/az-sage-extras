...
add_action( 'vc_before_init', 'tyro_vc_register_feature_icon_shortcode' );

/**
 * Register tyro-feature shortcode in Visual Composer
 */
function tyro_vc_register_feature_icon_shortcode() {

	vc_map( array(
		"name" => __( "Tyro LP Feature (With Icon)", "tyro" ),
		"base" => "tyro-feature-icon",
		"category" => __( "Tyro Widgets", "tyro" ),
		"icon" => get_template_directory_uri() . "/custom-content-elements/icons/tyro-content-elements-feature-icon-icon.png",
		"params" => array(
			array(
				"type"        => "attach_image",
				"class"       => "",
